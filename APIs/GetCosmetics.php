...
$cardBack = new stdClass();
$cardBack->name = "Bodega Loth-Cats";
$cardBack->id = 68;
$response->cardBacks[] = $cardBack;
...
$cardBack = new stdClass();
$cardBack->name = "TGB_Team";
$cardBack->id = 77;
$response->cardBacks[] = $cardBack;

$cardBack = new stdClass();
$cardBack->name = "Indy SWU";
$cardBack->id = 78;
$response->cardBacks[] = $cardBack;

$cardBack = new stdClass();
$cardBack->name = "Team serialized";
$cardBack->id = 79;
$response->cardBacks[] = $cardBack;
...
$cardBack = new stdClass();
$cardBack->name = "Pittsburgh Radar Technicians";
$cardBack->id = 83;
$response->cardBacks[] = $cardBack;
