...
if($p1SideboardSubmitted == "1" && $p2SideboardSubmitted == "1") {
  ...
  $currentPlayer = 0;
  $isReplay = 0;
  WriteCache($gameName, ($currentUpdate + 1) . "!" . $currentTime . "!" . $currentTime . "!-1!-1!" . $currentTime . "!"  . $p1Hero . "!" . $p2Hero . "!" . $visibility . "!" . $isReplay . "!0!0!" . FormatCode($format) . "!" . $MGS_GameStarted . "!0!0!$currentTime!0!0!!!!!1"); //Initialize SHMOP cache for this game
