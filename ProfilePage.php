...
<div class='fav-decks container bg-yellow'>
  ...
  $swustats_auth_url = "https://swustats.net/oauth/authorize?response_type=code&client_id={$swustats_client_id}&redirect_uri={$swustats_redirect_uri}&scope={$swustats_scopes}";
