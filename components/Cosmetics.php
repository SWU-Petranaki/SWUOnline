...
function CardbacksDropdowns($settings) {
  ...
  $rv .= CreateSelectOption($SET_Cardback . "-71", "Outer Rim CCG", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  $rv .= CreateSelectOption($SET_Cardback . "-72", "Dodonna&#039;s Disciples (light)", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  ...
  $rv .= CreateSelectOption($SET_Cardback . "-77", "TGB_Team", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  ...
  $rv .= CreateSelectOption($SET_Cardback . "-82", "Rebel Resource", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  $rv .= CreateSelectOption($SET_Cardback . "-83", "Pittsburgh Radar Technicians", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  $rv .= CreateSelectOption($SET_Cardback . "-84", "Team Shoot First [TSF]", $SET_Cardback . "-" . $settings[$SET_Cardback]);
  $rv .= CreateSelectOption($SET_Cardback . "-85", "Bachforellen Freunde Franken", $SET_Cardback . "-" . $settings[$SET_Cardback]);
